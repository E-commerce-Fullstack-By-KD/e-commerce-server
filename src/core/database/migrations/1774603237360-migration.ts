...
export class Migration1774603237360 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "is_deleted" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "sku" character varying NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product" ADD "list_price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "offer_price" numeric(10,2) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "stock" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
